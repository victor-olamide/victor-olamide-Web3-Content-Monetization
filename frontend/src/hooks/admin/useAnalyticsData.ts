...
export const useAnalyticsData = (dateRange: any, granularity: any) => {
  ...
  const fetchRealTimeData = useCallback(async () => {
    try {
      const response = await adminApi.getRealTimeData();
      if (response.success) {
 ...
 * User Analytics Hook
 */
export const useUserAnalytics = (dateRange: any, granularity: any) => {
 ...
 */
export const useContentAnalytics = (dateRange: any, granularity: any) => {
 ...
 */
export const useRevenueAnalytics = (dateRange: any, granularity: any) => {

...
/**
 * Deploy Content-Gate Contract to Stacks Testnet
 * 
 * This script deploys the content-gate.clar contract to the Stacks testnet.
 * It handles:
 ...
 * 
 * Usage: node deploy-cg-testnet.js
...
const CONTRACT_NAME = 'content-gate';
const CONTRACT_PATH = path.join(__dirname, '../contracts/content-gate.clar');
const DEPLOYMENT_INFO_PATH = path.join(__dirname, '../deployments/cg-testnet-deployment.json');
...
async function deployContract() {
  console.log('🚀 Deploying Content-Gate Contract to', NETWORK);
  ...
  try {
    ...
    console.log('1. Set CONTENT_GATE_ADDRESS environment variable to the sender address');
